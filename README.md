...
First, QUILT as a R library is available across all platforms, which can be simply installed by
...
cd QUILT
Rscript ./scripts/install-r-dependencies.R ## warnings can be ignored
```
