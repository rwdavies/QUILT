...
STITCH::make_STITCH_cli(
    ...
    other_character_params = c("phasefile", "output_RData_filename", "RData_objects_to_save", "prepared_reference_filename", "reference_exclude_samplelist_file", "output_sites_filename", "region_exclude_file", "small_ref_panel_block_gibbs_iterations", "reference_vcf_file"),
    ...
    other_integer_params = c("nGibbsSamples", "n_seek_its", "n_burn_in_seek_its", "Ksubset", "Knew", "K_top_matches", "panel_size", "bxTagUpperLimit", "seed", "gamma_physically_closest_to", "nMaxDH", "minimum_number_of_sample_reads", "small_ref_panel_gibbs_iterations", "pbwtL", "pbwtS", "mspbwt_nindices"),
...
STITCH::make_STITCH_cli(
    ...
    other_logical_params = c("make_fake_vcf_with_sites_list", "use_mspbwt", "use_pbwt_index"),
    other_integer_params = c("nMaxDH", "mspbwt_nindices"),
