...
STITCH::make_STITCH_cli(
    ...
    other_logical_params = c("make_plots", "verbose", "record_read_label_usage", "record_interim_dosages", "use_bx_tag", "addOptimalHapsToVCF", "estimate_bq_using_truth_read_labels", "make_plots_block_gibbs", "override_default_params_for_small_ref_panel", "hla_run", "make_fake_vcf_with_sites_list", "print_extra_timing_information", "plot_per_sample_likelihoods", "save_prepared_reference", "use_small_eHapsCurrent_tc", "output_gt_phased_genotypes", "use_mspbwt", "use_splitreadgl",  "use_hapMatcherR", "ff0_shard_check_every_pair", "use_eigen", "impute_rare_common", "make_heuristic_plot", "use_list_of_columns_of_A", "calculate_gamma_on_the_fly", "shard_check_every_pair", "output_read_label_prob"),
