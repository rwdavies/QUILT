...
STITCH::make_STITCH_cli(
    ...
    other_logical_params = c("make_fake_vcf_with_sites_list", "use_mspbwt", "use_zilong",  "use_hapMatcherR", "impute_rare_common"),
