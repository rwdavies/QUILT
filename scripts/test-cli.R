...
STITCH::make_STITCH_cli(
    ...
    other_character_params = c("phasefile", "output_RData_filename", "RData_objects_to_save", "prepared_reference_filename", "reference_exclude_samplelist_file", "output_sites_filename", "region_exclude_file", "small_ref_panel_block_gibbs_iterations", "reference_vcf_file", "heuristic_approach"),
