...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const arma::imat& >::type rhb_t(rhb_tSEXP);
    Rcpp::traits::input_parameter< const bool >::type use_eMatDH_special_symbols(use_eMatDH_special_symbolsSEXP);
    rcpp_calculate_gibbs_small_genProbs_and_hapProbs_using_binary_objects(genProbsM_t, genProbsF_t, hapProbs_t, gammaMT_t, gammaMU_t, gammaP_t, hapMatcher, distinctHapsB, distinctHapsIE, eMatDH_special_matrix_helper, eMatDH_special_matrix, which_haps_to_use, ref_error, rhb_t, use_eMatDH_special_symbols);
    return R_NilValue;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type always_normalize(always_normalizeSEXP);
    Rcpp::traits::input_parameter< const bool >::type normalize_emissions(normalize_emissionsSEXP);
    Rcpp_haploid_dosage_versus_refs(gl, alphaHat_t, betaHat_t, c, gamma_t, gammaSmall_t, best_haps_stuff_list, dosage, transMatRate_t, rhb_t, ref_error, use_eMatDH, distinctHapsB, distinctHapsIE, eMatDH_special_matrix_helper, eMatDH_special_matrix, use_eMatDH_special_symbols, hapMatcher, gammaSmall_cols_to_get, eMatDH_special_grid_which, eMatDH_special_values_list, K_top_matches, suppressOutput, min_emission_prob_normalization_threshold, return_betaHat_t, return_dosage, return_gamma_t, return_gammaSmall_t, get_best_haps_from_thinned_sites, is_version_2, return_extra, always_normalize, normalize_emissions);
    return R_NilValue;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_QUILT_rcpp_calculate_gibbs_small_genProbs_and_hapProbs_using_binary_objects", (DL_FUNC) &_QUILT_rcpp_calculate_gibbs_small_genProbs_and_hapProbs_using_binary_objects, 15},
    ...
    {"_QUILT_Rcpp_haploid_reference_single_forward_version2", (DL_FUNC) &_QUILT_Rcpp_haploid_reference_single_forward_version2, 23},
    {"_QUILT_Rcpp_haploid_reference_single_backward", (DL_FUNC) &_QUILT_Rcpp_haploid_reference_single_backward, 28},
    {"_QUILT_Rcpp_haploid_reference_single_backward_version2", (DL_FUNC) &_QUILT_Rcpp_haploid_reference_single_backward_version2, 33},
    {"_QUILT_Rcpp_haploid_dosage_versus_refs", (DL_FUNC) &_QUILT_Rcpp_haploid_dosage_versus_refs, 33},
    {NULL, NULL, 0}
};
