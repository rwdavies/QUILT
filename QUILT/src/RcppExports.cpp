...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_QUILT_sample_reads_in_grid", (DL_FUNC) &_QUILT_sample_reads_in_grid, 44},
    ...
    {"_QUILT_rcpp_gibbs_nipt_iterate", (DL_FUNC) &_QUILT_rcpp_gibbs_nipt_iterate, 50},
