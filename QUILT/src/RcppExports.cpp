...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_QUILT_Rcpp_shard_block_gibbs_resampler", (DL_FUNC) &_QUILT_Rcpp_shard_block_gibbs_resampler, 27},
